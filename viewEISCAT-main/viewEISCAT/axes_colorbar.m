...
% rect=[pos(1)+(1-stripe-edge)*pos(3) pos(2) stripe*pos(3) pos(4)];
  rect=[pos(1)+1.03*pos(3) pos(2)+pos(4)*0.1 .045*pos(3) pos(4)-0.02];
...
text('String',label,'Rotation',-90,'VerticalAlignment','middle',...
      'fontsize',fz+fz_add,'Units','normalized','position',[1.16 0.5],...
